...
window.addEventListener("keydown", function(e) {
	...
	var keyCode = e.which ? e.which : e.keyCode,
		title = ["0请高明", "1可赛艇", "2院视察", "3个代表", "4弦乐器", "5可奉告", "6四进京", "7因祸福", "8门外语", "9十大寿", "m安轨", "p判一番", "e可赛艇"];
	...
	else if (keyCode == 77) document.title = title[10];
	else if (keyCode == 80) document.title = title[11];
	else if (keyCode == 69) document.title = title[12];
});
